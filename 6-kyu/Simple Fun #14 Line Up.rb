...
#
# https://codefightsuserpics.s3.amazonaws.com/tasks/lineUp/img/example.png?_tm=1474804663999
#
# Input/Output
...
def line_up(cmd)
  inds, counter = [0, 1, 2, 3], 0
  cmd.each_char do |c|
    n = c == 'R' ? 1 : c == 'L' ? -1 : 2
    inds.rotate!(n)
    counter += 1 if %w[u r d l][inds[0]] == %w[u l d r][inds[0]]
  end
  counter
end
