...
def damaged_or_sunk (board, attacks)
  st = board.flatten.sort.uniq.map{|e| e != 0 ? [e, board.flatten.count(e)] : nil}.compact.to_h
  b = board.reverse
  attacks.each{|a| b[a[1]-1][a[0]-1] = 0}
  fi = b.flatten.sort.uniq.map{|e| e != 0 ? [e, b.flatten.count(e)] : nil}.compact.to_h
