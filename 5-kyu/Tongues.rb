...
a, b = %w[a i y e o u], %w[b k x z n h d c w g p v j q t s r l m f]
aj, bj, ar3j, br10j = a.join, b.join, a.rotate(3).join, b.rotate(10).join
ABC, GENDALF_ABC = aj + aj.upcase + bj + bj.upcase, ar3j + ar3j.upcase + br10j + br10j.upcase

def tongues(code)
  code.tr("#{ABC}", "#{GENDALF_ABC}")
end
